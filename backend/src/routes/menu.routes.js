...
menuRouter.get("/", verifyJWT, authorizeRoles("admin", "waiter", "kitchen"), getMenuItems);
menuRouter.get("/:id", verifyJWT, authorizeRoles("admin", "waiter", "kitchen"), getMenuItemById);
